            ...
            child:Stack(
              ...
              //  fit: StackFit.expand,
                children: <Widget>[
                  Positioned(left: 0,
                    ...
                    child: GestureDetector(
                      onTapDown: (details) async {
                        ...
                        setState(() {
                          if(wispause )
                          {wispause = false;play_Icons=icon2;
                          wfAliplayer.play(); }
                          else
                          {wispause = true;play_Icons=icon1;
                          wfAliplayer.pause();
                          }
                        });
                        print('手指按下'+ _tabIndex .toString());
                  ...
                  Positioned(left: _awidth-45, top: _aheight-45,
                    child:  IconButton(
            ...
            child:Stack(
              ...
              //  fit: StackFit.expand,
                children: <Widget>[
                  ...
                  Positioned(left: _awidth-70, top:_aheight- 70,
                    child:  IconButton(
                      icon:  const Icon(Icons.fullscreen_exit,size: 40,),
                      color: Colors.red,
                      alignment: Alignment.bottomRight,
                      onPressed: ()  {
