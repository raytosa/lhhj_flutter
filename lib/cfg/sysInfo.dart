import 'package:lhhj/cfg/flutter_avpdef.dart';
...
class BallInfo {
  ...
  late String col;
  late String sx;
  BallInfo(this.bno,this.col,this.sx);
}
class KaijiangInfo {
  late String qi;
  late String kjdate;
  late List<BallInfo> binfo;
  KaijiangInfo( String qi,   String kjdate,  List<BallInfo> binfo){
    this.qi=qi;
        this.kjdate=kjdate;
        this.binfo=binfo;
 }
...
class sysKaijiangInfo {
  late String r; late String s;  late int c; late String draw;late String date;late String begintime;

}
class SysInfo {
  final String hh; final List<sysKaijiangInfo>hhDate;

  const SysInfo({
    required this.hh,required this.hhDate,
  });
