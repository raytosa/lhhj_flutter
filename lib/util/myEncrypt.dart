...
class EncryptUtils {
  ///aes
  static late Key _keyAes=Key.fromUtf8('12345678900000001234567890000000');
  static late Encrypter _encryptAes;
  static IV _ivAes = IV.fromUtf8('1234567890000000');//IV.fromLength(16);
  ...
  ///Aes解密
  static String decryptAes64(String context) {
    return _encryptAes.decrypt(Encrypted.fromBase64(context), iv: _ivAes);
  }
  static String decryptAes16(String context) {
    return _encryptAes.decrypt(Encrypted.fromBase16(context), iv: _ivAes);
  }
  ///公钥Rsa加密
